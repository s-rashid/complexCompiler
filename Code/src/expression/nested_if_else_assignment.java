...
public class nested_if_else_assignment  extends Expression {
	Expression if_expression;
	Expression true_expression;
	Expression else_expression;

	
	public nested_if_else_assignment(Expression if_expression,Expression true_expression, Expression else_expression) {
